      ...
      items: [
        {
          ...
          roles: ['owner', 'master', 'accountant', 'supervisor', 'inventory_manager'],
        },
        {
        ...
        },
        {
          ...
          href: '/sell/parties',
          icon: Users,
          roles: ['owner', 'master', 'accountant', 'purchase', 'supervisor', 'inventory_manager'],
        },
        {
          label: 'Products Catalog',
          href: '/sell/products',
          icon: PackageCheck,
          roles: ['owner', 'master', 'accountant', 'inventory_manager', 'supervisor'],
        },
      ],
    },
    {
